...
class Example(QWidget):
	...
	def initUI(self):
		...
		# self.setWindowIcon(QtGui.QIcon(r"C:\Users\Rajat\Pictures\Test Pictures\yes.jpg"))
		# self.setWindowTitle(self.title)
		# self.setStyleSheet("background-color:#202020")
		self.init_img = r"C:\Users\tedlasai\PycharmProjects\ExposureStacks\Pictures\VF0410 Live! Cam Video IM Pro-0001-29-Mar-2022-15_09_37.jpg"

		self.labelImage = QLabel(self)
		self.horizontal_adjust.addWidget(self.labelImage)
		self.display_image(self.init_img)
	...
	def run_move_m1(self):
		...
		motor.motor1.moveCm(0.5, self.m1_direction)
