...
class Example(QWidget):
	...
	def __init__(self):
		...
		self.frame_switch = [0,0,0,0,0]
		self.torch_switch = [0,0,0,0,0]
	...
	def initUI(self):
		...
		self.frame_torch_dropdown_1_button.activated[str].connect(self.frame_torch_dropdown_1_selected)
		self.frame_torch_dropdown_2_button.activated[str].connect(self.frame_torch_dropdown_2_selected)
		self.frame_torch_dropdown_3_button.activated[str].connect(self.frame_torch_dropdown_3_selected)
		self.frame_torch_dropdown_4_button.activated[str].connect(self.frame_torch_dropdown_4_selected)
		self.frame_torch_dropdown_5_button.activated[str].connect(self.frame_torch_dropdown_5_selected)
	...
	def run_program(self):
		...
		self.frame_switch = [i for i in self.frame_switch if i != 0]
		self.torch_switch = [i for i in self.torch_switch if i != 0]
